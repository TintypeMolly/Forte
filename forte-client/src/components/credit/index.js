...
const Credit = () => {
  ...
  return (
    <div style={{padding: 10}}>
      ...
      <Card style={cardStyle}>
        <CardHeader title="박이재" subtitle="2016147546" avatar={forteImage}/>
        <CardText>프로젝트 관리 담당</CardText>
      </Card>
      <Card style={cardStyle}>
        <CardHeader title="윤희준" subtitle="2016147525" avatar={forteImage}/>
        <CardText>문서 및 PPT 작성 담당</CardText>
      </Card>
      <Card style={cardStyle}>
        <CardHeader title="황경윤" subtitle="2016147503" avatar={forteImage}/>
